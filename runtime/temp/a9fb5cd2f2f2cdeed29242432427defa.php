<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\wamp64\www\cms\public/../app/admin\view\category\index.html";i:1505103803;s:52:"E:\wamp64\www\cms\public/../app/admin\view\base.html";i:1509606784;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<table class="table table-striped jambo_table">
  <thead>
    <tr>
      <th><?php echo \think\Lang::get('thumbnail'); ?></th>
      <th>ID</th>
      <th><?php echo \think\Lang::get('cat_title'); ?></th>
  ...
  <tbody>
  <?php if(is_array($catlists) || $catlists instanceof \think\Collection || $catlists instanceof \think\Paginator): $i = 0; $__LIST__ = $catlists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cl): $mod = ($i % 2 );++$i;?>
    <tr>
      <td><?php if(!(empty($cl['thumbnail']) || (($cl['thumbnail'] instanceof \think\Collection || $cl['thumbnail'] instanceof \think\Paginator ) && $cl['thumbnail']->isEmpty()))): ?><img class="img-thumbnail img-responsive" style="max-width: 100px" src="/uploads/thumbnail/<?php echo $cl['thumbnail']; ?>"><?php endif; ?></td>
      <td><?php echo $cl['id']; ?></td>
      <td><?php echo $cl['title']; ?></td>
      <td><?php echo !empty($cl['status'])?'<i class="fa fa-check-circle-o green"></i>':'<i class="fa fa-times-circle-o red"></i>'; ?></td>
      <td><?php echo $cl['sorts']; ?></td>
      <td>
        <a href="<?php echo url('edit',['id'=>$cl['id']]); ?>" class="btn btn-primary btn-xs edit"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?></a>
        <a href="javascript:void(0)" title='<?php echo $cl['id']; ?>' data-dismiss="alert" class="btn btn-danger btn-xs delete"><i class="fa fa-close"></i> <?php echo \think\Lang::get('delete'); ?></a>
      </td>
    </tr>
