<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\wamp64\www\cms\public/../app/admin\view\article\index.html";i:1505225255;s:52:"E:\wamp64\www\cms\public/../app/admin\view\base.html";i:1509310922;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<table class="table table-striped jambo_table">
  ...
  <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
      <td><?php if(!(empty($vo['thumbnail']) || (($vo['thumbnail'] instanceof \think\Collection || $vo['thumbnail'] instanceof \think\Paginator ) && $vo['thumbnail']->isEmpty()))): ?><img src="/uploads/thumbnail/<?php echo $vo['thumbnail']; ?>" class="img-thumbnail img-responsive" style="max-width: 150px"><?php endif; ?></td>
