<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"E:\wamp64\www\cms\public/../app/admin\view\user\index.html";i:1509308661;s:52:"E:\wamp64\www\cms\public/../app/admin\view\base.html";i:1509310922;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<table class="table table-striped jambo_table">
  <thead>
    <tr>
      ...
      <th><?php echo \think\Lang::get('username'); ?></th>
      <th><?php echo \think\Lang::get('name'); ?></th>
      <th><?php echo \think\Lang::get('email'); ?></th>
      <th><?php echo \think\Lang::get('mobile'); ?></th>
      <th><?php echo \think\Lang::get('logins'); ?></th>
      <th><?php echo \think\Lang::get('status'); ?></th>
      <th><?php echo \think\Lang::get('control'); ?></th>
    </tr>
  </thead>
  <tbody>
    <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "no recode" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
    	<td><?php echo $vo['id']; ?></td>
    	<td><img src="/uploads/avatar/<?php echo (isset($vo->userInfo->avatar) && ($vo->userInfo->avatar !== '')?$vo->userInfo->avatar:null); ?>" class="img-circle img-thumbnail" style="max-width: 100px" alt="<?php echo $vo['name']; ?>_avatar"></td>
    	...
    	<td>
    		<a href="<?php echo url('edit',['id'=>$vo['id']]); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?></a>
