<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\wamp64\www\cms\public/../app/admin\view\auth_rule\index.html";i:1504912687;s:52:"E:\wamp64\www\cms\public/../app/admin\view\base.html";i:1509606784;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<table class="table table-striped jambo_table">
  <thead>
    <tr>
      <th><?php echo \think\Lang::get('auth_title'); ?></th>
      <th><?php echo \think\Lang::get('auth_name'); ?></th>
      <th><?php echo \think\Lang::get('auth_level'); ?></th>
  ...
  <tbody>
    <?php if(is_array($trees) || $trees instanceof \think\Collection || $trees instanceof \think\Paginator): $i = 0; $__LIST__ = $trees;if( count($__LIST__)==0 ) : echo "no recode" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
      <td>
      <?php switch($vo['level']): case "2": ?>  |--<?php break; case "3": ?>  |  |--<?php break; default: endswitch; ?><?php echo $vo['title']; ?>
      </td>
      <td><?php echo $vo['name']; ?></td>
      <td>
      <?php switch($vo['level']): case "1": ?><?php echo \think\Lang::get('project'); break; case "2": ?><?php echo \think\Lang::get('model'); break; default: ?><?php echo \think\Lang::get('control'); endswitch; ?>
      </td>
      <td><?php echo !empty($vo['status'])?'<i class="fa fa-check-circle-o green"></i>':'<i class="fa fa-times-circle-o red"></i>'; ?></td>
      <td><?php echo !empty($vo['ismenu'])?'<i class="fa fa-check-circle-o green"></i>':'<i class="fa fa-times-circle-o red"></i>'; ?></td>
      <td><?php if(!(empty($vo['icon']) || (($vo['icon'] instanceof \think\Collection || $vo['icon'] instanceof \think\Paginator ) && $vo['icon']->isEmpty()))): ?><i class="<?php echo $vo['icon']; ?>"></i><?php endif; ?></td>
    ...
    <?php endforeach; endif; else: echo "no recode" ;endif; ?>
  </tbody>
</table>
